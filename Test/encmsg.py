...
lblReference = tk.Label(f1, font = ('arial', 16, 'bold'),
                            text = "Name:", bd = 16, anchor = "w")

lblReference.grid(row = 0, column = 0)

txtReference = tk.Entry(f1, font = ('arial', 16, 'bold'),
...
lblService = tk.Label(f1, font = ('arial', 16, 'bold'),
                          text = "The Result-", bd = 16, anchor = "w")

lblService.grid(row = 2, column = 2)

txtService = tk.Entry(f1, font = ('arial', 16, 'bold'),
...
btnTotal = tk.Button(f1, padx = 16, pady = 8, bd = 16, fg = "black",
                         ...
                         command = message).grid(row = 7, column = 1)

# Reset button
btnReset = tk.Button(f1, padx = 16, pady = 8, bd = 16,
                         fg = "black", font = ('arial', 16, 'bold'),
                         width = 10, text = "Reset", bg = "green",
                         command = full_reset).grid(row = 7, column = 2)

# Exit button
btnExit = tk.Button(f1, padx = 16, pady = 8, bd = 16,
                        fg = "black", font = ('arial', 16, 'bold'),
                        width = 10, text = "Exit", bg = "red",
                        command = quick_exit).grid(row = 7, column = 3)
